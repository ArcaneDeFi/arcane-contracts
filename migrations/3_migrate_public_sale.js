...
module.exports = function(deployer, network, accounts) {
    ...
    let name = "Litecoin Public Sale";
    let totalSupply = ether("1000000");
    let tokenPrice = ether("0.075");
    let vestingType = VESTING_TYPE.LINEAR_VESTING;
    let periodDuration = 86400;
    let countPeriod = 100;
    let cliffDuration = 0;
    let initialUnlockPercentage = ether('10');
    let maxAllocation = ether("7500");
    let minAllocation = ether("0");
    let intervals = [];
    let startDate = 1651748400 - 20 * 60; // Thu May 05 2022 11:00:00 GMT+0000
    let endDate = 1652180400; //   Tue May 10 2022 11:00:00 GMT+0000
    ...
    deployer.then(async() => {
        ...
        await rewardToken.approve(vest.address, ether('6000'));
        console.log("Approved!");

        await vest.deposit(ether('6000'));
